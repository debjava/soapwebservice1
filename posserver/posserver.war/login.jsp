                    ...
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <!-- <td><input type="submit" name="Login" value="Login" onClick="doLogin();"/></td> -->
                            </tr>
                        </table>
                    </fieldset>
                </td>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    value="http://localhost:8080/posserver/card?msgid=100&pin=1234&cardno=4267&pname=deba" size="120">
                                </td>
                            </tr>
                            <tr>
                                <td/>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    value="http://localhost:8080/posserver/transaction?msgid=200&pin=1234&pname=deba&cardno=4267&cvv=111&amt=1000" size="120">
                                </td>
                            </tr>
                            <tr>
                                <td/>

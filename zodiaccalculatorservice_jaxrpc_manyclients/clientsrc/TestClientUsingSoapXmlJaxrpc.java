...
public class TestClientUsingSoapXmlJaxrpc 
{
	public static void main(String[] args) throws Exception
	{
		...
		URL endpoint = new URL("http://localhost:8080/zodiaccalculatorservice_jaxrpc_manyclients/ZodiacCalculatorService?WSDL");

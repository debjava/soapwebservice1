...
public class CFEUtil 
{
    ...
    NoSuchAlgorithmException{
          ...
          try{
                ...
                new String(h.get("firstname").toString().getBytes("UTF-8"))+

                new String(h.get("lastname").toString().getBytes("UTF-8"))+
	...
	public static String calculateCheckSum140(HashMap h)throws
	UnsupportedEncodingException,
	NoSuchAlgorithmException{
		String hash = "";
		try{
...
//			last+
			...
			byte[] data1 = unistr.getBytes("UTF-8");//UTF-8
			lcStringtohash = new String( data1 , "UTF-8");
			
//			byte[] data = unistr.getBytes("ISO-8859-1");
			//For testing
...
//			byte[] data1 = c.encode(lcStringtohash).array();
...
//			byte[] data = lcStringtohash.getBytes("ISO-8859-9");//UTF-8
...
//		}		
	...
	public static String calculateCheckSum2(HashMap h)throws
	UnsupportedEncodingException,
	NoSuchAlgorithmException{
		String hash = "";
		try{

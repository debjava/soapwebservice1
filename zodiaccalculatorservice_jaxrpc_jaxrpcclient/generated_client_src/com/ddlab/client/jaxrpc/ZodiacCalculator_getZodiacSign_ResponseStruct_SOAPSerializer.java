...
public class ZodiacCalculator_getZodiacSign_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public ZodiacCalculator_getZodiacSign_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct instance = new com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct();
        com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_result_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct instance = (com.ddlab.client.jaxrpc.ZodiacCalculator_getZodiacSign_ResponseStruct)obj;
